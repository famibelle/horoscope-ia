...
const platforms = [
  ...
  },
  {
    ...
    url: (text: string) => `https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(text)}`,
  },
  {
    id: 'instagram',
    name: 'Instagram',
...
const BASE_SHARE_TEXT = '🌿 Mon horoscope ancestral, Découvrez la sagesse de Karukera et les paroles de Fanchette sur Zodyak Karukera';

export default function ShareButtons({ signName }: { signName?: string }) {
  const [copied, setCopied] = useState(false);
  const shareText = signName
    ? `🌿 Mon horoscope ${signName} du jour, Découvrez la sagesse de Karukera et les paroles de Fanchette sur Zodyak Karukera`
    : BASE_SHARE_TEXT;
  ...
  return (
    <section id="partager" className="px-4 py-10 max-w-2xl mx-auto">
      <motion.div
