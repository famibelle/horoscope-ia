...
export const ARTICLES: ArticleMeta[] = [
  ...
  {
    slug: 'baron-samedi-mort-renaissance',
    emoji: '💀',
  ...
  {
    slug: 'damballa-serpent-sagesse',
    emoji: '🐍',
    title: 'Damballa, le grand serpent arc-en-ciel',
    excerpt:
      "Damballa ne parle pas. Il siffle. Il glisse entre les arbres et les nuages comme un arc-en-ciel vivant. C'est le plus ancien des loas, celui d'avant les mots. Et c'est lui qui tient le monde.",
    tag: 'Vaudou',
    tagColor: 'from-ancestral-forest to-ancestral-gold',
    readTime: '7 min',
  },
