  ...
  return (
    <main className="max-w-4xl mx-auto px-4 py-12">
      ...
      <section className="mb-8">
        ...
        <p className="text-ancestral-cream/80 text-base sm:text-lg leading-[1.75]">
      ...
      <section className="mb-8">
        ...
        <p className="text-ancestral-cream/80 text-base sm:text-lg leading-[1.75] mb-3">
          Le Site propose les services suivants :
        </p>
        <ul className="list-disc list-inside text-ancestral-cream/80 text-base sm:text-lg leading-[1.75] space-y-2 ml-4">
        ...
        <p className="text-ancestral-cream/80 text-base sm:text-lg leading-[1.75] mb-3">En utilisant le Site, vous vous engagez à :</p>
        <ul className="list-disc list-inside text-ancestral-cream/80 text-base sm:text-lg leading-[1.75] space-y-2 ml-4">
