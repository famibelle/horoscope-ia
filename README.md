...
TELEGRAM_CHAT_ID=VOTRE_CLE_ICI

# Buzzsprout (Podcast)
BUZZSPROUT_API_TOKEN=VOTRE_CLE_ICI
BUZZSPROUT_PODCAST_ID=VOTRE_CLE_ICI
...
B2_BUCKET_NAME=VOTRE_CLE_ICI
B2_ENDPOINT=VOTRE_CLE_ICI
...
SPOTIFY_PLAYLIST_ID=VOTRE_CLE_ICI
